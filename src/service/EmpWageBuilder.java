package service;
import Interface1.IEmployeeWage;
import model.CompanyEmpWage;

public class EmpWageBuilder extends IEmployeeWage {
    ...
    public static void main(String[] args) {
        ...
        ((EmpWageBuilder) empWageBuilder).addCompanyEmpWage("ABC", 20, 100, 20);
        ((EmpWageBuilder) empWageBuilder).addCompanyEmpWage("Apple", 25, 120, 25);
        ((EmpWageBuilder) empWageBuilder).empWageArray();
    }
